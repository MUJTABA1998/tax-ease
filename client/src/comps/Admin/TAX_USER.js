      ...
      {user === undefined ? (
        ...
        <div className="tax-content-wrapper">
          ...
          <div>
            ...
            {user.docs.map((file, index) => (
              <div className="file-wrapper" key={index}>
                <img src={`/uploads/TAX/${file}`} alt={file} />
                <div className="action-section">
                  <a href={`/uploads/TAX/${file}`} download>
                    <AiOutlineDownload />
                  </a>
                </div>
              </div>
          ...
          <div className="file-wrapper">
            ...
            <img src={`/uploads/TAX/${user.bankState}`} alt={user.bankState} />
            <div className="action-section">
              <a href={`/uploads/TAX/${user.bankState}`} download>
                <AiOutlineDownload />
              </a>
            </div>
          </div>
