...
import CreateAcc from "./comps/CreateAcc";
import Main from "./comps/Main";
import Services from "./comps/Services";
import NtnReg from "./comps/NtnReg";
import Cart from "./comps/Cart";
import AOP from "./comps/AOP";
import Sole from "./comps/Sole";
import Tax from "./comps/Tax Return/Tax";
...
import NTN from "./comps/Admin/NTN";
...
function App() {
  ...
  useEffect(() => {
    ...
    fetchTaxUsers();
    fetchLawyers();
  }, [setUsers, setNtn, setAop, setSole, setTax, setLawyers]);
        ...
        <Router>
          <Routes>
            ...
            <Route path="user/:id" element={<Main />}>
              ...
              <Route
                path="ntn-registeration"
                element={<NtnReg cart={cart} setCart={setCart} />}
              />
              <Route
                path="aop-registeration"
                element={<AOP cart={cart} setCart={setCart} />}
              />
              <Route
                path="sole-registeration"
                element={<Sole cart={cart} setCart={setCart} />}
              />
              <Route
                path="tax-return"
                element={<Tax cart={cart} setCart={setCart} />}
              />
              <Route
                path="cart"
            ...
            <Route path="tax-ease-admin" element={<Dasborad />}>
              ...
              <Route path="ntn" element={<NTN ntn={ntn} />} />
